                        ...
                        <TableRow key={id}>
                            <TableCell>
                                <Link href={`/companions/${id}`}>
                                    ...
                                    <div className="size-[75px] flex justify-center items-center rounded-lg max-md:hidden"
                            ...
                            <TableCell>
                                ...
                                <div className="flex items-center justify-center rounded w-fit p-2 md:hidden "
                                style={{backgroundColor:getSubjectColor(subject)}}>
